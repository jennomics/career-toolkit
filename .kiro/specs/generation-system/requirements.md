...
| Assert | Assert not |
|---|---|
| `linkedin.com/in/jennomics` | `jennalang` |
| `30 million customer genomes` | `proprietary sequences`, `genotype database`, `human genomes` |
| ten years watching personalized medicine fail | fifteen years |
